...
for i in range(1):
    ...
    model = MultiModalityPerceiver(
        modalities=(feature3_modality,feature4_modality,feature5_modality),
    ...
    ckpt = "ckpt/at_ckpt/FGSM-PCO/humor_reg/VARMAT.pt"
    ...
    records=train(model,epochs,[trains4],[valid4],[test4],[['feature4','feature5','feature3']],ckpt,lr=0.0008,device=device,train_weights=[1.0],is_affect=[False],unsqueezing=[False],transpose=[False],evalweights=[1],start_from=0,weight_decay=0.001)